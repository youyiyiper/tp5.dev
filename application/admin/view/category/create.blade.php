            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-inverse" data-sortable-id="form-validation-1">
                    ...
                    <div class="panel-body panel-form">
                        <form class="form-horizontal form-bordered" data-parsley-validate="true" action="{{ url('admin/category') }}" method="POST">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="flag" placeholder="标识" value="{{ old('flag') }}" data-parsley-required="true" data-parsley-required-message="请输入标识" data-parsley-length="[2,30]" data-parsley-length-message="标识长度2~30字符" />
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="control-label col-md-2 col-sm-2" for="desc">分类描述 * :</label>
                                <div class="col-md-4 col-sm-4">
                                    <input class="form-control" type="text" name="desc" placeholder="描述" value="{{ old('desc') }}" data-parsley-required="true" data-parsley-required-message="请输入描述" data-parsley-length="[2,100]" data-parsley-length-message="描述长度2~100字符" />
                                </div>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="col-md-4 col-sm-4">
                                    <select class="form-control selectpicker"
                                        ...
                                        <option value="{{ $category->id }}">{{ str_repeat('&nbsp;',$category->level * 4) }}{{ $category->name }}</option>
                                        @endforeach
                                    </select>
